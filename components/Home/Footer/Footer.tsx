...
const Footer = () => {
  return (
      <div className='pt-1 pb-10 bg-[#2d112f]'>
          <div>
          <Image src={"/images/logo.svg"} alt='Faizan Personal Logo' width={380} height={50} className='mx-auto' />
          </div>
          ...
          <p className='text-white text-opacity-60 mt-6 text-center'>© 2024 All Rights Reserved by Faizan Naqvi </p>
